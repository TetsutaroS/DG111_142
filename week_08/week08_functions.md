...
**คำตอบ: เพราะว่า value ไปก็อปค่า hp มาไม่ใช่ตัวแปรเดียวกัน**

### 2.2 `lerp` — Local Scope

**คำถาม:** ทำไม `main()` ถึงมองไม่เห็นตัวแปร `result` ทั้งที่มันถูกประกาศไว้ในไฟล์เดียวกัน?

**คำตอบ: เพราะ result ประกาศไว้ในฟังชั่น lerp main เลยไม่เห็นตัวแปร result**
...
**คำตอบ: เพราะ diceMin ประกาศอยู่ใน main ไม่ได้ประกาศไว้ใน randomRange และเป็นคนละตัวแปรกัน**
